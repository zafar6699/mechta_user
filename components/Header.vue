    ...
    <div>
        ...
        <nav class="navbar">
            <div class="navbar-inner">
                ...
                <ul class="nav-link">
                    <li>
                        <nuxt-link to="/product">Главная</nuxt-link>
                    </li>
                    <li>
                        <nuxt-link to="/productAbout">О продукции</nuxt-link>
                    </li>
                    ...
                    <li><a href="#">Для оптовых клиенты</a></li>
                </ul>
            </div>
        </nav>
    </div>
